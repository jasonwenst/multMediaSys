...
<head>
	...
	<script type="text/javascript" src="<%=basePath %>app/material/app.js"></script>
	<script type="text/javascript" src="<%=basePath %>app/material/controller/materialCtrl.js"></script>
	<script type="text/javascript" src="<%=basePath %>app/material/service/materialService.js"></script>
